...
* BorderLayout to input Student names, scores, and calculate 
...
public class Student_Grades_Window_BorderLayout extends JFrame
{
   ...
   * Sets the layout to border regions.
   ******************************************************************/  
  public Student_Grades_Window_BorderLayout()
  {
  ...
  {       
    ...
    southPanel.add(scorePrompt);
    southPanel.add(scoreText);
    southPanel.setBackground(Color.GREEN);
    add(southPanel, BorderLayout.SOUTH);
    
    westPanel.add(showTotal);
    westPanel.add(totalText);
    westPanel.setBackground(Color.RED);
    add(westPanel, BorderLayout.WEST);
    
    eastPanel.add(showAverage);
    eastPanel.add(AverageText);
    eastPanel.setBackground(Color.BLUE);
    add(eastPanel, BorderLayout.EAST);
    
    centerPanel.add(showLetterGrade);
    centerPanel.add(LetterGradeText);
  ...
  {
    new Student_Grades_Window_BorderLayout();
  }	// end of main method
}	// end of program